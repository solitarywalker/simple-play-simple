...
local function load(g)
	...
	local note_types = {}
	if		g.type == 0	then note_types	= {1,2,3,4,5,6,7,"s"}
	elseif	g.type == 1	then note_types	= {1,2,3,4,5,"s"}
	elseif	g.type == 4	then note_types	= {1,2,3,4,5,6,7,8,9}
	elseif	g.type == 3	then note_types	= {1,2,3,4,5,"s",5,4,3,2,1,"s"}
	elseif	g.type == 2	then note_types	= {1,2,3,4,5,6,7,"s",7,6,5,4,3,2,1,"s"}
	end
	...
	do
		local init = {"s",1,2,3,4,5,6,7,8,9}
