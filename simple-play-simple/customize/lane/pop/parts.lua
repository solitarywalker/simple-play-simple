...
local function load(g)
	...
	parts.image = {
		...
		{id = "lane-6",			src = "src-lane-4",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-7",			src = "src-lane-3",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-8",			src = "src-lane-2",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-9",			src = "src-lane-1",		x = 0, y = 0, w = -1, h = -1}
	}
	parts.destination = {}
