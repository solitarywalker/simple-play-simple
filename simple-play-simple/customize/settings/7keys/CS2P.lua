...
local function load(header)
	...
	-- BGA
	t.frame.bga = {
		{x = 0, y = 44, w = 992, h = 992, a = 255, brightness = 255, stretch = 1}
	}

	-- グルーブゲージ
	t.frame.gauge.x		= t.lanes.x[1] - 142
	t.frame.gauge.y		= 64
	t.frame.gauge.h		= 36
