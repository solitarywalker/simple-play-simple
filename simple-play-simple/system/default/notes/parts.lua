...
local function load(g)
	...
	local note_types = {}
	if		g.type == 0	then note_types	= {"w","b","w","b","w","b","w","s"}
	elseif	g.type == 1	then note_types	= {"w","b","w","b","w","s"}
	elseif	g.type == 4	then note_types	= {"w","b","w","b","w","b","w","b","w"}
	elseif	g.type == 3	then note_types	= {"w","b","w","b","w","s","w","b","w","b","w","s"}
	elseif	g.type == 2	then note_types	= {"w","b","w","b","w","b","w","s","w","b","w","b","w","b","w","s"}
	end
	...
	parts.source = {
		{id = "src-notes-s", path = "default/notes/s.png"},
		{id = "src-notes-w", path = "default/notes/w.png"},
		{id = "src-notes-b", path = "default/notes/b.png"},
		{id = "src-barline", path = "default/notes/barline.png"}
	}
