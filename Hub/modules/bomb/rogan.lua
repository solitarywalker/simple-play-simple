...
local function load(file_path, lane, lanes, offset, bomb_offset)
	...
	parts.source = {
		{id = "hub-src-rgbomb", path = file_path}
	}
	parts.image = {
		{id = "hub-bomb", src = "hub-src-rgbomb", x = 0, y = 0, w = -1, h = -1}
	}
	parts.imageset = {}
	parts.destination = {
	...
	do
		...
		for i, v in ipairs(init) do
			if v == "s" then
				table.insert(parts.image, {id = "hub-bomb" .. v,		src = "hub-src-rgbomb", x = 0, y = 0,			w = -1,			h = 300, divx = 16,	timer = 50, cycle = 251})
				table.insert(parts.image, {id = "hub-fastbomb" .. v,	src = "hub-src-rgbomb", x = 0, y = 600,			w = -1,			h = 300, divx = 16,	timer = 50, cycle = 251})
				table.insert(parts.image, {id = "hub-slowbomb" .. v,	src = "hub-src-rgbomb", x = 0, y = 300,			w = -1,			h = 300, divx = 16,	timer = 50, cycle = 251})
				table.insert(parts.image, {id = "hub-hold" .. v,		src = "hub-src-rgbomb", x = 0, y = hold_y[i],	w = 400 * 8,	h = 300, divx = 8,	timer = 70, cycle = 160})
				...
				table.insert(parts.image, {id = "hub-bomb" .. i,		src = "hub-src-rgbomb", x = 0, y = 0,			w = -1,			h = 300, divx = 16,	timer = 50 + i, cycle = 251})
				table.insert(parts.image, {id = "hub-fastbomb" .. i,	src = "hub-src-rgbomb", x = 0, y = 600,			w = -1,			h = 300, divx = 16,	timer = 50 + i, cycle = 251})
				table.insert(parts.image, {id = "hub-slowbomb" .. i,	src = "hub-src-rgbomb", x = 0, y = 300,			w = -1,			h = 300, divx = 16,	timer = 50 + i, cycle = 251})
				table.insert(parts.image, {id = "hub-hold" .. i,		src = "hub-src-rgbomb", x = 0, y = hold_y[i],	w = 400 * 8,	h = 300, divx = 8,	timer = 70 + i, cycle = 160})
		...
		for i, v in ipairs(init) do
			if v == "s" then
				table.insert(parts.image, {id = "hub-bomb2" .. v,		src = "hub-src-rgbomb", x = 0, y = 0,			w = -1,			h = 300, divx = 16,	timer = 60, cycle = 251})
				table.insert(parts.image, {id = "hub-fastbomb2" .. v,	src = "hub-src-rgbomb", x = 0, y = 600,			w = -1,			h = 300, divx = 16,	timer = 60, cycle = 251})
				table.insert(parts.image, {id = "hub-slowbomb2" .. v,	src = "hub-src-rgbomb", x = 0, y = 300,			w = -1,			h = 300, divx = 16,	timer = 60, cycle = 251})
				table.insert(parts.image, {id = "hub-hold2" .. v,		src = "hub-src-rgbomb", x = 0, y = hold_y[i],	w = 400 * 8,	h = 300, divx = 8,	timer = 80, cycle = 160})
				...
				table.insert(parts.image, {id = "hub-bomb2" .. i,		src = "hub-src-rgbomb", x = 0, y = 0,			w = -1,			h = 300, divx = 16,	timer = 60 + i, cycle = 251})
				table.insert(parts.image, {id = "hub-fastbomb2" .. i,	src = "hub-src-rgbomb", x = 0, y = 600,			w = -1,			h = 300, divx = 16,	timer = 60 + i, cycle = 251})
				table.insert(parts.image, {id = "hub-slowbomb2" .. i,	src = "hub-src-rgbomb", x = 0, y = 300,			w = -1,			h = 300, divx = 16,	timer = 60 + i, cycle = 251})
				table.insert(parts.image, {id = "hub-hold2" .. i,		src = "hub-src-rgbomb", x = 0, y = hold_y[i],	w = 400 * 8,	h = 300, divx = 8,	timer = 80 + i, cycle = 160})
