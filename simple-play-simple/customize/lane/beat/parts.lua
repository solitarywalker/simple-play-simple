...
local function load(g)
	...
	parts.image = {
		...
		{id = "lane-1",			src = "src-lane-w",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-2",			src = "src-lane-b",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-3",			src = "src-lane-w",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-4",			src = "src-lane-b",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-5",			src = "src-lane-w",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-6",			src = "src-lane-b",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-7",			src = "src-lane-w",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-8",			src = "src-lane-b",		x = 0, y = 0, w = -1, h = -1},
		{id = "lane-9",			src = "src-lane-w",		x = 0, y = 0, w = -1, h = -1}
	}
	parts.destination = {}
